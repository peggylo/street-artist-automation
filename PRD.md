...
### 3.1 標準申請流程（AI語意解析）
**情境：媽媽在8月5日說「申請」，系統自動判斷申請9月份**

| 步驟 | 用戶操作 | Bot回應 | 系統處理 |
|------|----------|---------|----------|
| 1 | 媽媽：「申請」 | 「收到！9月份申請（自動判斷）」<br/>「預設日期：9/7(六), 9/14(六), 9/21(六)」<br/>「要使用這些日期嗎？」 | AI解析申請意圖，傳統系統推算月份並計算預設日期 |
| 2 | 媽媽：「確認」 | 「日期確認完成！」<br/>「請選擇使用的影片：」<br/>「1. 使用常用影片（預設）」<br/>「2. 上傳新影片」<br/>「請說『常用影片』或『新影片』」 | AI理解確認意圖，記錄日期選擇，主動詢問影片選擇 |
| 3a | 媽媽：「常用影片」 | 「使用常用影片，開始處理申請...」 | AI理解選擇，使用常用影片，觸發自動化 |
| 3b | 媽媽：「新影片」 | 「請上傳新的影片」<br/>「直接在這裡傳送影片檔案即可」 | AI理解選擇，進入新影片上傳流程 |
| 4b | 媽媽：[上傳影片檔案] | 「影片收到！」<br/>「開始處理申請，請稍候...」 | 系統處理新影片存到Drive，觸發自動化 |
| 5 | (等待) | 「申請已成功提交！」 | 完成所有處理流程 |

### 3.2 自訂日期流程（AI語意解析）
**情境：媽媽在9月5日說「申請」要修改日期，只要10月的第1個週六和第1個週日**

| 步驟 | 用戶操作 | Bot回應 | 系統處理 |
|------|----------|---------|----------|
| 1 | 媽媽：「申請」 | 「收到！10月份申請（自動判斷）」<br/>「預設日期：10/5(六), 10/12(六), 10/19(六)」<br/>「要使用這些日期嗎？」 | AI解析申請意圖，傳統系統推算月份並計算預設日期 |
| 2 | 媽媽：「修改」 | 「10月份可選日期：」<br/>「週六：10/5, 10/12, 10/19, 10/26」<br/>「週日：10/6, 10/13, 10/20, 10/27」<br/>「請告訴我要哪幾天」 | AI理解修改意圖，傳統系統計算可選日期並提供選項 |
| 3 | 媽媽：「第一個週六和第一個週日」 | 「確認申請日期：」<br/>「10/5 (週六) 和 10/6 (週日)」<br/>「這樣正確嗎？」 | AI解析自然語言日期選擇 |
| 4 | 媽媽：「對」 | 「日期確認完成！」<br/>「請選擇使用的影片：」<br/>「1. 使用常用影片（預設）」<br/>「2. 上傳新影片」<br/>「請說『常用影片』或『新影片』」 | AI確認意圖，主動詢問影片選擇 |
| 5a | 媽媽：「常用影片」 | 「使用常用影片，開始處理申請...」 | AI理解選擇，執行自動化流程 |
| 5b | 媽媽：「新影片」 | 「請上傳新的影片」<br/>「直接在這裡傳送影片檔案即可」 | AI理解選擇，進入上傳流程 |
| 6b | 媽媽：[上傳影片] | 「影片收到！」<br/>「開始處理申請...」 | 系統處理影片，執行自動化流程 |
...
| 步驟 | 用戶操作 | Bot回應 | 系統處理 |
|------|----------|---------|----------|
| 1 | 媽媽：「藥深頃」 | 「收到！要申請下個月的場地嗎？」 | AI解析：intent="apply", confidence=0.85，直接執行 |
| 2 | 媽媽：「對」 | 「9月份申請（自動判斷）」<br/>「預設日期：9/7(六), 9/14(六), 9/21(六)」<br/>「要使用這些日期嗎？」 | AI確認申請意圖，進入申請流程 |
